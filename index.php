    ...
    <section id="home" class="home">
        ...
        <div class="featuredProjectsContainer row">
            ...
            <div class="featuredProjectCard col-12 col-md-4">
                ...
                <p>This recent project, developed using HTML, presents a gallery displaying a variety of images. It has interactive elements like a button for dark and light mode, and collapse and expand buttons.</p>
            </div>
            <div class="featuredProjectCard col-12 col-md-4">
    ...
    <section id="projects" class="projects" style="display: none;">
        ...
        <div class="projectsContainer">
            <div class="projectsCards row">
                ...
                <div class="card col-12 col-sm-6 col-md-4">
                    <h3 style="margin-top:100px;">Project 2</h3>
                    <p>A06</p>
                    <a href="A06/index.php"></a>
                </div>
                <div class="card col-12 col-sm-6 col-md-4">
                    <h3 style="margin-top:100px;">Project 3</h3>
                    <p>A07</p>
                    <a href="A07/index.php"></a>
                </div>
                <div class="card col-12 col-sm-6 col-md-4">
